...
> Online working version of following example is available on plunkr: http://plnkr.co/edit/oyF9jO
...
clazz of clazz instance depending on properties type. Converters is applied to value before property constraints 
and type check.
